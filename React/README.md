...
Так же не забываем про топик [JS](https://github.com/fullstack-development/front-end-best-practices/tree/master/JS), в котором много полезных правил не в зависимости от фреймворков.
...
- [3.1](#3.1) Для svg-иконок задавайте свойство `fill` в значение `currentColor`. Так можно будет менять цвет иконки из CSS.

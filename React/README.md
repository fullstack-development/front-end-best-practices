...
3. [SVG](#4)
4. [Экспорт](#5)
5. [Переменные окружения](#6)
6. [Работа с API](#7)
7. [Общие принципы работы со стейт менеджерами](#8)
8. [Общее](#9)
...
Прежде всего отталкивайтесь от договорённостей на проекте. Договоритесь с коллегами о стиле именования заранее или придерживайтесь уже существующих правил на проекте. Вот какой стиль используем мы:

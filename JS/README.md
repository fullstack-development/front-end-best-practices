...
## [Именование функций](#function-naming)

<a name="function-naming--start-with-verbs) Все имена функций, за редкими исключениями (например, следование уже устоявшемуся соглашению в рамках какой-нибудь библиотеки"></a>

...
- [1.1](#1.1) Объединять блоки не по их визуальному расположению, а по их смыслу.
  ...
  ![хороший пример](https://github.com/fullstack-development/developers-roadmap/assets/90761929/db6e1f7c-59d9-41dd-8334-ca96d7a07049)

  А не вот так:  
  ![плохой пример](https://github.com/fullstack-development/developers-roadmap/assets/90761929/16982193-66b0-447e-bf32-3956f2f3a584)
...
- [2.13](#2.13) Все ссылки с `target="_blank"` должны так же содержать атрибут `rel="noreferrer"`.

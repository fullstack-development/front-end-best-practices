...
- [1.3](#1.3) CSS — опасная сила.
  ...
  Для того чтобы такого не происходило, существуют различные готовые решения - [CSS Modules](https://github.com/css-modules/css-modules), CSS-in-JS (напр., [styled-components](https://styled-components.com/)), [tailwindcss](https://tailwindcss.com/) и др. Если ни одно из этих решений вам недоступно, воспользуйтесь `БЭМ` (прочитать про него обязательно хотя бы в общих чертах) или, например, [rscss](https://ricostacruz.com/rscss/index.html). Для начала можете изучить [небольшой подход](https://isobar-us.github.io/code-standards/), который используют ребята из `Isobar` — он описан в рамках их стандарта и состоит из 7 небольших абзацев.
